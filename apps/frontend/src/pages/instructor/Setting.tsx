    ...
    >
      <header className="flex justify-between items-end mb-10">
        <div>
          ...
          <p className="text-outline text-sm">Manage your instructor profile, notification preferences, and account security.</p>
        </div>
      ...
      <div className="grid grid-cols-12 gap-8">
        <section className="col-span-12 lg:col-span-8 space-y-8">
          <div className="bg-surface-low p-8 rounded-sm border border-outline-variant/5">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="font-headline text-xl font-medium">Profile Settings</h2>
            </div>
          ...
          <div className="bg-surface-low p-8 rounded-sm border border-outline-variant/5">
            ...
            <div className="space-y-4">
              {[
                { label: 'Student enrollment alerts', desc: 'Receive notifications when students are assigned to your courses', active: true },
                { label: 'Quiz submissions', desc: 'Notify when new quiz attempts are recorded', active: true },
                { label: 'System updates', desc: 'Receive platform maintenance and release notices', active: false },
              ].map((pref, i) => (
        ...
        <section className="col-span-12 lg:col-span-4 space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="p-3 bg-surface rounded-sm flex items-center justify-between border-l border-secondary">
                  <span className="text-xs font-mono">Multi-factor enabled</span>
          ...
          <div className="relative overflow-hidden p-6 rounded-sm bg-primary/5 backdrop-blur-md border-t border-primary/15 glass-panel">
            <div className="flex items-center gap-2 mb-4">
              <Sparkles className="text-primary" size={18} />
              <span className="font-headline text-sm font-bold tracking-tight">AI Insight</span>
            </div>
            <p className="text-xs text-outline leading-relaxed mb-4">Based on recent activity, student engagement in <span className="text-secondary">CoSc4411</span> is predicted to improve next week. Consider uploading reinforcement resources for weaker topics.</p>
