    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      <div className="mb-10 flex justify-between items-end">
        ...
        <div className="flex gap-4">
          <button className="px-5 py-2 rounded bg-surface-high text-on-surface font-medium hover:bg-white/10 transition-colors active:scale-95">Discard</button>
          <button className="px-5 py-2 rounded bg-primary-brand text-surface font-bold hover:brightness-110 transition-all active:scale-95 shadow-lg shadow-primary-brand/10">Apply Protocol</button>
        </div>
      </div>

      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-4 rounded-xl p-6 bg-primary-brand/5 backdrop-blur-xl border border-primary-brand/10 flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center mb-6">
              <span className="font-mono text-[10px] uppercase tracking-widest text-secondary-accent">System Pulse</span>
          ...
          <div className="mt-8">
            ...
            <div className="h-1.5 w-full bg-surface-high rounded-full overflow-hidden">
              <div className="h-full bg-secondary-accent w-4/5"></div>
            </div>
          </div>
        </div>

        <div className="col-span-12 lg:col-span-8 bg-surface-low rounded-xl p-8 border border-white/5">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input 
                  className="w-full bg-surface-high border-none rounded p-3 text-on-surface focus:ring-1 focus:ring-primary-brand transition-all" 
                  type="text" 
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-surface-high rounded-lg group hover:bg-white/5 transition-colors cursor-pointer">
                <div>
                ...
                <div className="w-12 h-6 bg-secondary-accent/20 rounded-full relative">
                  <div className="absolute right-1 top-1 w-4 h-4 bg-secondary-accent rounded-full shadow-sm"></div>
                </div>
              </div>
              <div className="flex items-center justify-between p-4 bg-surface-high rounded-lg group hover:bg-white/5 transition-colors cursor-pointer">
                <div>
        ...
        <div className="col-span-12 lg:col-span-7 bg-surface-low rounded-xl p-8 border border-white/5">
          <div className="flex justify-between items-center mb-8">
            <h2 className="font-headline text-2xl font-semibold">Roles & Hierarchies</h2>
            <button className="flex items-center gap-2 text-xs font-mono bg-primary-brand/10 text-primary-brand px-3 py-1.5 rounded hover:bg-primary-brand/20 transition-all">
          ...
          <div className="space-y-4">
            {[
              { icon: CheckCircle2, label: 'Super Admin', tags: ['ALL_ACCESS', 'PROTOCOL_WRITE'], count: '3 USERS', color: 'text-secondary-accent' },
              ...
              <div key={i} className="grid grid-cols-12 items-center p-4 bg-surface rounded hover:bg-surface-high transition-all group border border-white/5">
                ...
                <div className="col-span-5 flex gap-1">
                  {role.tags.map(tag => (
                    <span key={tag} className="bg-primary-brand/10 text-primary-brand px-2 py-0.5 rounded text-[10px] font-mono">{tag}</span>
                  ))}
                </div>
        ...
        <div className="col-span-12 lg:col-span-5 bg-surface-low rounded-xl p-8 relative overflow-hidden border border-white/5">
          ...
          <div className="flex flex-col gap-6 relative z-10">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full border border-secondary-accent/30 flex items-center justify-center bg-secondary-accent/5">
                <Shield className="text-secondary-accent w-6 h-6 fill-secondary-accent/20" />
              </div>
              <div>
              ...
              <div className="ml-auto">
                <span className="text-[10px] bg-secondary-accent/20 text-secondary-accent px-2 py-1 rounded font-mono">ACTIVE</span>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full border border-primary-brand/30 flex items-center justify-center bg-primary-brand/5">
                <Lock className="text-primary-brand w-6 h-6 fill-primary-brand/20" />
              </div>
              <div>
          ...
          <div className="absolute -right-16 -bottom-16 w-64 h-64 opacity-10">
            <Cpu className="w-full h-full text-primary-brand" />
          </div>
        </div>
      </div>
    </div>
