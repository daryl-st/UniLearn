  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      <div className="mb-10 flex justify-between items-end">
        <div>
          <h1 className="text-4xl font-headline font-bold text-on-surface tracking-tight mb-2">System Settings</h1>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-4 rounded-xl p-6 bg-primary/5 backdrop-blur-xl border border-primary/10 flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center mb-6">
              <span className="font-mono text-[10px] uppercase tracking-widest text-secondary">Platform Health</span>
              <span className="w-2 h-2 rounded-full bg-secondary animate-pulse"></span>
            </div>
            <h3 className="font-headline text-xl font-bold mb-2">Operational Status</h3>
            <p className="text-sm text-on-surface-variant opacity-70">Core admin services are stable and security policies are actively enforced.</p>
          </div>
          <div className="mt-8">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label className="block text-xs font-mono text-on-surface-variant tracking-wider uppercase">Platform Name</label>
                <input 
                  className="w-full bg-surface-high border-none rounded p-3 text-on-surface focus:ring-1 focus:ring-primary transition-all" 
                  type="text" 
                  defaultValue="UniLearn"
                />
              </div>
              <div className="space-y-2">
        ...
        <div className="col-span-12 lg:col-span-5 bg-surface-low rounded-xl p-8 relative overflow-hidden border border-outline-variant/10">
          ...
          <p className="text-xs text-on-surface-variant font-mono mb-8 opacity-60">Security and governance status overview</p>
          <div className="flex flex-col gap-6 relative z-10">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-sm font-bold">Account Governance Rules</div>
                <div className="text-[10px] text-on-surface-variant">Role changes and deactivation rules enforced</div>
              </div>
              <div className="ml-auto">
                <span className="text-[10px] bg-surface-high text-on-surface-variant px-2 py-1 rounded font-mono">ENFORCED</span>
              </div>
            </div>
          </div>
