        ...
        <div className="lg:col-span-8 space-y-10">
          <div className="space-y-4">
            ...
            <p className="text-on-surface-variant leading-relaxed">
              Resources uploaded for this course. Open a file link to study offline; AI summaries and quizzes are not wired yet.
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3 text-[13px] text-on-surface-variant">
                    ...
                    <span>Open course resources from the list (links open in a new tab).</span>
                  </li>
